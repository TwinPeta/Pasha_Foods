      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="assets/img/slide/slide_4.png" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Pasha Foods</span></h2>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="assets/img/slide/slide_3.png" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">Our Mission</h2>
                <p class="animate__animated animate__fadeInUp">To be number one at providing best meals
                  Come and enjoy the best, tasty and delicious meals at our restaurant or
                  Order online and we deliver, thank you. Looking forwad to warmly receive you.
                </p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Welcome to <strong>Pasha Foods</strong></h3>
            <h5>The best provider of delicious and quality 
            Come and enjoy the best, tasty and delicious meals at our restaurant or
                  Order online and we deliver, thank you. Looking forwad to warmly receive you
          </h5>
          <div class="social-media">
          <a href="https://www.facebook.com/theoriginalpashafoodsltd/"><i class="fab fa-facebook-f"></i></a>
          <br>
  <a href="https://www.instagram.com/pashafood/"><i class="fab fa-instagram"></i></a>
  <br>
